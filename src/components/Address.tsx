                        ...
                        <div key={index}>
                            ...
                            <div className="mt-10 space-y-5">
                                <div className="flex items-center">
                                    <div className="_icon-wrapper_1a3wa_1 text-sky-500 dark:text-white/70 text-base"
                                       >
