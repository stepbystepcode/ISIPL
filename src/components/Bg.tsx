    ...
    return (
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="2106" height="1327">
            ...
            <g fill="none" fillRule="evenodd">
                <path fill="#6D28D9" fillOpacity=".72"
                      ...
                      filter="url(#hi-a)" transform="translate(0 -605)"></path>
                <path fill="#67E8F9" fillOpacity=".64"
                      ...
                      filter="url(#hi-b)" transform="translate(0 -605)"></path>
                <path fill="#F472B6" fillOpacity=".8"
                      ...
                      filter="url(#hi-c)" transform="translate(0 -605)"></path>
            </g>
        </svg>
)
    ;
